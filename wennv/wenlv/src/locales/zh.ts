...
export default {
  ...
  routes: {
    ...
    daysUnit: '天',
    stopsLabel: '途经景点',
    // 主题筛选:theme=culture 为蜀文化叙事路线,其余玩法主题词经 themeMap 按语言映射
    filterAll: '全部',
    themeCultural: '文化主题',
    themeMap: {
      城市经典: '城市经典',
  ...
  quiz: {
    ...
    explain: '解析',
    next: '下一题',
    resultScore: '答对 {correct}/{total} 题',
    rankLabel: '文化段位',
    rankBronze: '青铜',
    rankSilver: '白银',
    rankGold: '黄金',
    badgeWall: '徽章墙',
    badgeCount: '已获 {count} 枚徽章',
    badgeTotalCorrect: '累计答对 {count} 题 · 答对题目的景点会记入徽章',
    goQuiz: '答题',
  },
  culture: {
    badge: '四川省 · 成都',
  ...
  passport: {
    eyebrow: '数字足迹',
    title: '旅行护照',
    hero: '上传现场照片打卡集章，印章永久保存；集满生成专属护照证书',
    progress: '已集 {count} / {total} 枚',
    stampEmpty: '还没有印章，去景点页上传照片打卡，开启你的集章之旅吧',
    generate: '生成护照证书',
    download: '下载 PNG',
    close: '关闭',
    generating: '证书生成中…',
    ...
    collect: '去集章',
    loginRequired: '登录后开始打卡集章，印章会永久保存到你的账号',
    loginCta: '去登录',
  },
  checkin: {
    button: '打卡集章',
    ...
    modalTitle: '景点打卡',
    modalDesc: '上传 1~9 张现场照片并提交，即可为「旅行护照」盖下专属印章（照片上传至 OSS，印章永久保存）',
    pickPhotos: '添加照片',
    photoLimit: '最多上传 9 张照片',
    commentPlaceholder: '写下此刻的旅行感言（可选）',
    cancel: '取消',
    submit: '确认打卡',
    submitting: '处理中…',
    submitFailed: '打卡失败，请稍后重试',
    uploadFailed: '照片上传失败，请重试',
    uploadProgress: '已上传 {done}/{total} 张',
    rewardTitle: '集章成功！',
    rewardDesc: '这枚印章已永久存入你的旅行护照',
  },
  login: {
    title: '登录',
    backHome: '返回首页',
  ...
  favorites: {
    ...
    countLabel: '项收藏',
    empty: '还没有收藏内容',
    emptyHint: '在探索、美食或路线页点亮心形，收藏你喜欢的内容',
    goExplore: '去探索',
    unfavorite: '取消收藏',
    viewDetail: '查看详情',
    sectionScenic: '景点',

 ...
 *          + 留白冷月 / 飞鸟淡墨 / 飞白江水 + 杜甫诗句竖排逐字墨书 + 朱砂印章
 * 水墨语言：宣纸纤维肌理 + 墨滴入水晕开聚形 + 纸缘暖调微晕 + 落款朱砂
 * 退出条件：最短停留 3.6s 且 Hero 大图预加载完成（6s 兜底强制放行）
        ...
        <div class="scroll-paper">
          ...
          <div class="poem">
            <span class="poem__col">
              <i class="ch" style="--i: 0">窗</i><i class="ch" style="--i: 1">含</i><i class="ch" style="--i: 2">西</i><i class="ch" style="--i: 3">岭</i><i class="ch" style="--i: 4">千</i><i class="ch" style="--i: 5">秋</i><i class="ch" style="--i: 6">雪</i>
            </span>
            <span class="poem__col">
              <i class="ch" style="--i: 7">门</i><i class="ch" style="--i: 8">泊</i><i class="ch" style="--i: 9">东</i><i class="ch" style="--i: 10">吴</i><i class="ch" style="--i: 11">万</i><i class="ch" style="--i: 12">里</i><i class="ch" style="--i: 13">船</i>
            </span>
...
.poem__sig {
  ...
  animation: sig-fade 0.6s ease 2.5s both;
}
...
.poem__seal {
  ...
  animation: seal-stamp 0.55s cubic-bezier(0.2, 1.4, 0.4, 1) 2.8s both;
}
...
.intro__title {
  ...
  font-weight: 700;
  color: #26211A;
  animation: intro-title 1s ease 3s both;
}
...
.intro__sub {
  ...
  text-align: center;
  animation: intro-fade-up 0.9s ease 3.2s both;
}
